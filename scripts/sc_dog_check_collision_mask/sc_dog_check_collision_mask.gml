...
switch dir {
case d.Up:
	mask_index = sp_dog_collision_top
	break
case d.Down:
	mask_index = sp_dog_collision_bottom
	break
case d.Left:
	mask_index = sp_dog_collision_left
	break
case d.Right:
	mask_index = sp_dog_collision_right
}
